...
First, we reduce the influence of synonym and polysemy with the LSA method.
Second, aging theory is introduced to represent the sentence with other four categories of feature which are common used in this field. 
...
All the features are used in our experiments as follows:
\begin{table}
\centering
...
For evaluate the performance of our methd, we used the dataset of TAC 2011 summary task, whic is an open benchmark dataset published by Text Analysis Conference(http://www.nist.gov/tac/).
