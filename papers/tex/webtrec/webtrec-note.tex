...
\graphicspath{{images/}}
\usepackage{url}
\urldef{\mailsa}\path|{sonyfe25cp@gmail.com, zniu@bit.edu.cn, syl_bit@163.com,|
\urldef{\mailsb}\path|zcm_xinxi@163.com,li_weiyin@qq.com}|
...
%
\authorrunning{Note about ad-hoc task of  web track 2013}
